...
public class SixStairsConfig extends DeimosConfig {
    ...
    @Entry public static List<String> blockStairsList = Lists.newArrayList(
            ...
            "minecraft:exposed_cut_copper, minecraft:exposed_cut_copper_stairs",
            "minecraft:granite, minecraft:granite_stairs",
            "minecraft:jungle_planks, minecraft:jungle_stairs",
            "minecraft:mangrove_planks, minecraft:mangrove_stairs",
            ...
            "minecraft:oxidized_cut_copper, minecraft:oxidized_cut_copper_stairs",
            ...
            "minecraft:polished_tuff, minecraft:polished_tuff_stairs",
            ...
            "minecraft:chiseled_quartz_block, minecraft:quartz_stairs",
            "minecraft:quartz_block, minecraft:quartz_stairs",
            "minecraft:quartz_pillar, minecraft:quartz_stairs",
            "minecraft:red_nether_bricks, minecraft:red_nether_brick_stairs",
            "minecraft:red_sandstone, minecraft:red_sandstone_stairs",
            "minecraft:chiseled_red_sandstone, minecraft:red_sandstone_stairs",
            "minecraft:cut_red_sandstone, minecraft:red_sandstone_stairs",
            "minecraft:sandstone, minecraft:sandstone_stairs",
            "minecraft:chiseled_sandstone, minecraft:sandstone_stairs",
            "minecraft:cut_sandstone, minecraft:sandstone_stairs",
            ...
            "minecraft:tuff, minecraft:tuff_stairs",
            "minecraft:warped_planks, minecraft:warped_stairs",
            "minecraft:waxed_cut_copper, minecraft:waxed_cut_copper_stairs",
